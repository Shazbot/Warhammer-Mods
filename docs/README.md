# 1. Getting started with WH2 Lua scripting

## 1.1. Setting up your Lua coding environment

### 1.1.1. Get Visual Studio Code

<https://code.visualstudio.com/download>

### 1.1.2. Get the Lua extension by sumneko

<https://marketplace.visualstudio.com/items?itemName=sumneko.lua>

### 1.1.3. Download my Warhammer-Mods repo and extract it

<https://github.com/Shazbot/Warhammer-Mods/archive/master.zip>

![download repo as zip](images/download_repo.png)

### 1.1.4. Add the autocomplete folder from my repo to your workspace

![add folder to workspace](images/add_folder_to_workspace.png)

### 1.1.5. In the problems panel enable "Show Active File Only"
...
### 1.1.6. As long as you code inside this workspace you'll get autocomplete

![autocomplete is now active](images/autocomplete.png)

## 1.2. Onward to a better workflow
...
### 1.2.1. Mods we need from the workshop
...
### 1.2.3. Execute our _exec.lua_ file
...
### 1.2.5. How script executing works
...
### 1.2.6. Learning Lua and the WH2 Lua API
