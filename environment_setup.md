...
## 3. Download my Warhammer-Mods repo an extract it
...
What we're trying to avoid is having to restart the game when making code changes. We can't learn or be productive if we don't have an enviroment that is conductive to that, and the exec.lua file will provide just that.
...
The big remification of this are listeners.
...
If you're new to programmming I suggest you go over the [Codecademy JavaScript tutorial](https://www.codecademy.com/learn/introduction-to-javascript), most of the core concepts carry over between all programming languages.
